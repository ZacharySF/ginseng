...
<section class="analysis-panel" aria-label="Funding risk limits">
	...
	<p>Coverage sets the reserve quantile and the tail fraction. These controls limit the size of buffer deficits in the optimizer.</p>
	<form onsubmit={apply}>
		...
		<p class="analysis-note">An average $100 deficit lasting three days uses 300 dollar-days. Blank uses 5% × buffer × evaluation days.</p>
