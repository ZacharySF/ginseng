...
<style>
	...
	.deterministic-note { display:flex; flex-wrap:wrap; align-items:baseline; gap:.55rem 1rem; padding:.85rem 1rem; background:var(--paper-deep); border-bottom:1px solid var(--rule); }.deterministic-note strong { color: var(--link); font-family:var(--font-mono); font-size:.68rem; letter-spacing:.045em; text-transform:uppercase; }.deterministic-note p { flex:1 1 25rem; color:var(--ink-soft); font-size:.76rem; line-height:1.4; }.deterministic-note a,.policy-link { color: var(--link); font-size:.72rem; font-weight:700; }
